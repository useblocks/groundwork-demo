...
try:
    release = pkg_resources.get_distribution('groundwork_demo').version
except pkg_resources.DistributionNotFound:
    print('groundwork-demo must be installed to build the documentation.')
...
html_theme_options = {
    "contribute": True,
    "github_fork": "useblocks/groundwork-demo",
...
#
# html_title = 'groundwork-demo v0.1'
...
htmlhelp_basename = 'groundwork-demodocs'
...
latex_documents = [
    (master_doc, 'groundwork-demo.tex', 'groundwork-demo Documentation',
...
man_pages = [
    (master_doc, 'groundwork-demo', 'groundwork-demo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'groundwork-demo', 'groundwork-demo Documentation',
     author, 'groundwork-demo', 'One line description of project.',
     'Miscellaneous'),
]
